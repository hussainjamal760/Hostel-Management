                    ...
                    <div className="p-6 bg-surface rounded-2xl shadow-sm border border-outline-variant hover:border-secondary transition-colors group">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex justify-between items-center p-3 bg-surface-container-lowest rounded-xl border border-outline-variant/50">
                                ...
                                <span className={`font-bold text-white px-2 py-0.5 rounded-md ${room.occupiedBeds > 0 ? (room.occupiedBeds >= room.totalBeds ? 'bg-error-container text-error' : 'bg-primary-container text-primary') : 'bg-surface-container text-on-surface'}`}>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            {Array.from({ length: room.totalBeds }).map((_, index) => {
                                ...
                                return (
                                    <div
                                        key={index}
                                        className={`p-5 rounded-2xl border-2 transition-all group relative overflow-hidden ${isOccupied
