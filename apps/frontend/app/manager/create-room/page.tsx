...
import { useBulkCreateRoomsMutation, useGetRoomsQuery } from '@/lib/services/roomApi';
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-brand-text dark:text-dark-text">Create Room</h1>
          <p className="text-sm text-brand-text/60 dark:text-dark-text/60">Generate and configure new rooms</p>
        </div>
      </div>
