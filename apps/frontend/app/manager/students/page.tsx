                ...
                {['ALL', 'PAID', 'DUE'].map((status) => {
                    ...
                    return (
                        <button
                            ...
                            className={`px-6 py-2.5 rounded-full text-label-md uppercase tracking-wider font-bold transition-all flex items-center gap-2 whitespace-nowrap ${isSelected
                                    ...
                                    <tr key={student._id} className="hover:bg-surface-container-lowest transition-colors group">
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="flex flex-col gap-1.5 items-start">
                                                ...
                                                <span className="text-label-sm text-white uppercase tracking-wider font-bold text-primary bg-primary-container px-2 py-0.5 rounded-md flex items-center gap-1">
                                        ...
                                        <td className="px-6 py-4">
                                            <span className={`px-3 py-1.5 text-label-md uppercase tracking-wider font-bold rounded-xl flex items-center gap-1.5 w-fit ${student.feeStatus === 'PAID' ? 'bg-green-100 text-green-700 border border-green-200' :
            ...
            {!isLoading && (studentsData?.pagination?.total || 0) > 0 && (
                <div className="flex flex-col sm:flex-row items-center justify-between gap-4 bg-surface p-4 rounded-2xl shadow-sm border border-outline-variant">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <span className="hidden sm:flex items-center justify-center min-w-[40px] h-10 px-4 text-label-md font-bold bg-primary-container text-white rounded-xl">
