...
import { HiCheck, HiX, HiOfficeBuilding, HiUser, HiTrash, HiSearch } from 'react-icons/hi';
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Global Complaints</h1>
          <p className="text-gray-500 dark:text-gray-400">Manage issues across all hostels</p>
        </div>
                ...
                <div className="flex flex-col md:flex-row justify-between items-start gap-4 mb-4">
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <span className="text-xs font-mono text-gray-400">#{complaint._id.slice(-4)}</span>
                    </div>
